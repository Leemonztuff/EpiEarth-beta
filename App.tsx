...
const App = () => {
  ...
  useEffect(() => {
    ...
    window.onerror = (msg, url, line, col, error) => {
      logger.general.error(`[GLOBAL ERROR] ${String(msg)} at ${String(url)}:${line}:${col}`, error);
      return previousOnError ? previousOnError(msg, url, line, col, error) : false;
    };

    window.onunhandledrejection = (event) => {
      logger.general.error('[UNHANDLED REJECTION]', event.reason);
