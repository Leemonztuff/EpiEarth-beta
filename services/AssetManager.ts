...
export const AssetManager = {
    ...
    asset_aliases: new Map<string, string>([
        ['/assets/backgrounds/forest_bg.png', '/assets/wesnoth/terrain/grass/green.png'],
        ['/assets/sprites/tree_1.png', '/assets/wesnoth/terrain/forest/deciduous-summer-tile.png'],
        ['/sprites/characters/slime_01.png', '/assets/wesnoth/units/monsters/mudcrawler.png'],
    ]),
    ...
    getSafeSprite(path: string | undefined): string {
        ...
        const directAlias = this.asset_aliases.get(path);
        if (directAlias) {
            return directAlias;
        }
        ...
        const cleanAlias = this.asset_aliases.get(`/${cleanPath}`) || this.asset_aliases.get(cleanPath);
        if (cleanAlias) {
            return cleanAlias;
        }
